...
Jeigu į kūrybingumą žiūrėti iš šios pusės, tai gerokai nustekena mintį, jog turi būti apdovanotas, gabus, jog galėtum išsiskirti, vadintis "kūbybingu". Visi gali atrasti įdomių tarpusavio sąsajų, idėjų, sujungti taškus tarpusavyje įdomiais būdais, skirtumas tik tiek, kad yra praleidžiamas skirtingas laiko kiekis tas mintis išreiškiant. Tai kaip raumuo, kuo daugiau tuo užsiimi - tuo geriau gaunasi. O nuo to kaip gerai moki visą tai išreikšti, priklauso kaip lengvai seksis kitiems tai suprasti ir priimti.
