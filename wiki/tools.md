...
* [Pinboard ](https://pinboard.in/)- nebrangus \(11$ metams, 25 norint turėti turinio cache'avimą ir full text paiešką\), jokių reklamų ir jokio trackinimo. Programuotojų mylimas no bullshit servisas su puikiu funkcionalumu, tačiau old schooliniu dizainu \(kai kuriems tai yra labiau pliusas\). Bookmarksai iš esmės atvaizduojami panašiai, kaip Google paieškos rezultatai. Naudojantis mac'u, galima pasidaryti gan puikų flow su Alfred.
* [Raindrop](https://raindrop.io/) - komandos iš Sankt Peterburgo kūrinys. Labai intuityvus ir responsive įrankis, turintis puikų įskiepį, kurį galima nusistatyti naudoti kaip web clipperį arba kaip mini app'są, iš kurios galima greitai ieškoti ir pasiekti bet kurį bookmarks'ą. Nested kategorijos pasiekamos tik mokomoje versijoje, tačiau antrą lygį kataloge galima įgyvendinti naudojantis tiesiog tag'ais, kurie patogiai atvaizduojami įėjus į karegoriją. Taipogi susimokėjus vienam mėnesiui galima pasidaryti visą savo nested kategorijų struktūrą ir nutraukus prenumeratą galima ja naudotis ir toliau, vienintelis apribojimas, kad nebebus galima kurtis naujų vidinių kategorijų. Yra platus ikonų support'as, mobilūs apps'ai, dark mode, 4 atvaizdavimo būdai, automatiniai tag suggestion'ai, įskiepis visiems pagrindiniams browseriams. Mokomoje versijoje prisideda atsiranda dublikatų paieška, turinio archyvinis cache'avimas, broken link tikrinimas ir pan. Pagrindiniai minusai: raginimas pereiti į mokamą versiją, ne itin aiškios ateities perspektyvos ir privacy klausimai.
